...
#ifndef YS_LOG_LEVEL
#define YS_LOG_LEVEL			LOG_LEVEL_VERBOSE
#endif

#define LOG_LEVEL				YS_LOG_LEVEL

#if YS_LOG_LEVEL <= LOG_LEVEL_INFO
...
#if YS_LOG_LEVEL <= LOG_LEVEL_WARNING
...
#if YS_LOG_LEVEL <= LOG_LEVEL_ERROR
...
#if YS_LOG_LEVEL <= LOG_LEVEL_VERBOSE
